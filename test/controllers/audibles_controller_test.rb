...
class AudiblesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create audible" do
    assert_difference('Audible.count') do
      post audibles_url, params: { audible: { audio_file: @audible.audio_file, by: @audible.by, language: @audible.language, title: @audible.title } }, as: :json
    end
  ...
  test "should update audible" do
    patch audible_url(@audible), params: { audible: { audio_file: @audible.audio_file, by: @audible.by, language: @audible.language, title: @audible.title } }, as: :json
    assert_response 200
  end
